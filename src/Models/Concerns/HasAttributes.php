<?php namespace Frc\Payrix\Models\Concerns;

use Carbon\CarbonImmutable;
use Carbon\CarbonInterface;
use DateTimeImmutable;
use DateTimeInterface;
use Frc\Payrix\Exceptions\InvalidCastException;
use Frc\Payrix\Exceptions\JsonEncodingException;
...
trait HasAttributes
{
    ...
    {
        return $this->hasCast($key, ['array', 'json', 'object', 'collection', 'encrypted:array', 'encrypted:collection',
    ...
    {
        return $this->hasCast($key, ['encrypted', 'encrypted:array', 'encrypted:collection', 'encrypted:json',
            'encrypted:object'
        ]);
    }
    ...
    protected function isClassCastable($key)
    {
        ...
        throw new InvalidCastException($key, $castType);
    }
